...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	Guest g= new Guest(1, "KIM","2020","aaa.gmail.com","http//aa.naver.com","타이틀","테스트테스트");  //bean
	
	Student s = new Student(1,"KIM", 11, new Car(12345,"BMW", "blue"));
	Date d=new Date();
