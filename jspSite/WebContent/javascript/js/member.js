...
function load_focus(){
	...
	function join_form_submit_button(){
		//var id = window.document.joinFrm.id.value;
	...
	function join_form_button(){
		...
		*/
		...
		document,getComputedStyle('joinFrm').action='../4.join.jsp';
		document,getComputedStyle('joinFrm').method='post';
		document,getComputedStyle('joinFrm').submit();
