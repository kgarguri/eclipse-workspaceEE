							...
							<table border="0" cellpadding="0" cellspacing="1" width="590">
								<tr>
									<td align="center">
										 ...
										 <%}%>
										 <%if(boardListPage.pageMaker.getPrevGroupStartPage()>0) {%>    
											<a href="./board_list_page_maker.jsp?pageno=<%=boardListPage.pageMaker.getPrevGroupStartPage()%>">◀</a>&nbsp;&nbsp;
										 <%}%>
										...
										<%
										 ...
										 <%if(boardListPage.pageMaker.getNextGroupStartPage()< boardListPage.pageMaker.getTotPage()){%>
										  <a href="./board_list_page_maker.jsp?pageno=<%=boardListPage.pageMaker.getNextGroupStartPage()%>">▶&nbsp;</a>
										 <%}%>
										 <%if(boardListPage.pageMaker.getNextGroupStartPage()< boardListPage.pageMaker.getTotPage()){%>
										<a
